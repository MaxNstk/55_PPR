...
import builder3.produto.Director;
...
public class  CadastroContato extends JFrame {
	...
	private void initComponents() {
		...
		jrInternet.setActionCommand("builder3.ConstruirParaInternet");
		...
		jrTelefone.setActionCommand("builder3.ConstruirParaTelefone");
		...
		jrCompleto.setActionCommand("builder3.ConstruirPessoa");
		...
		jb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					campos.put(Director.NOME,jtfNome.getText());
					campos.put(Director.ENDERECO,jtfEndereco.getText());
					campos.put(Director.TELEFONE,jtfTelefone.getText());
					campos.put(Director.EMAIL,jtfEmail.getText());

					director.construir(campos);
		...
		jb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					// Por ora, desconsidere o JRadioRadioButton... usaremos outro padrao junto com 
