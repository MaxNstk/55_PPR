...
import abstractfactory3.controle.correio.CorreioFactory;
import abstractfactory3.controle.exportarEUA.ExportarEUAFactory;
	...
	public void setTipoFrete(String tipoFrete) {
		...
		if (tipoFrete.equals("Correio")) {
			...
			// criar o concretefactory de exportar para america do norte
			 this.freteFactory = new ExportarEUAFactory();
		}
		for (Observador obs : obss) {
			obs.tipoFreteSetado();
		}
