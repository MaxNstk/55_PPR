...
import abstractfactory1.dao.randomaccessfactory.RandomAccessFactory;
import abstractfactory1.dao.xmlfactory.DadosXMLFactory;
...
public class  TelaCliente {
	...
	private static DadosFactory createFactory() throws Exception {
    	...
    	if (factory.equals("xml"))
    		return new DadosXMLFactory();
    	else
    		return new RandomAccessFactory();
	}
