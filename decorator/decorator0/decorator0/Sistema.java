...
public class Sistema {
	...
	public static void main(String[] args) {
		...
		ServicoEmailBase servicoTraduzido = new TraduzirAssuntoDecorator(servico1, "porto riquenho");
		ServicoEmailBase maisDestinos = new DecoratorMaisDestinos(servicoTraduzido, "max@", "addsd", "eqwe");
		maisDestinos.enviar(email1);
