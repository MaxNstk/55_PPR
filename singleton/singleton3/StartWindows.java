			...
			public void actionPerformed(ActionEvent arg) {
				...
				JDialog jinc = new JDialog() {
					...
					public void pack() {
						...
						// final Incrementar inc = new Incrementar();
						final ScreenCounter counter  = ScreenCounter.getInstance();
						...
						jb.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
								//	inc.inc();
								counter.increaseScreenAmount();
								jl.setText(String.valueOf(counter.getScreenAmount()));
