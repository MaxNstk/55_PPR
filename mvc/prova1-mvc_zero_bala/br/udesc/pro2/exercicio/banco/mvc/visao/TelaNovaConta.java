...
public class TelaNovaConta extends JFrame implements ObserverNovaConta {
    ...
    private ControladorNovaConta controller;

    public TelaNovaConta(){
        init();
        controller = new ControladorNovaConta();
        controller.anexarObservador(this);
        controller.atualizarInfo();
        ...
        btnSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    validarCampos();
                    controller.salvarConta(getNomeCorrentista(), getTipoConta(), getBanco());
                    fecharTela();
    ...
    @Override
    public void salvandoContas(ContaCorrente conta) {
        exibirMensagem("Conta "+String.valueOf(conta.getCodigo())+" cadastrada com sucesso");
    }
}
