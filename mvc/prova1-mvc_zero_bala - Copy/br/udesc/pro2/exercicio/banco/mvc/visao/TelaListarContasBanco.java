...
public class TelaListarContasBanco extends JFrame {
    ...
    public void adicionarAcaoCbBanco(ItemListener acao) {
        cbBanco.addItemListener(acao);
    }
    ...
    public void popularComboBoxBanco(List<Banco> bancos) {
        for (Banco banco : bancos) {
            cbBanco.addItem(banco);
        }
    }

    public void popularDataTable(List<ContaCorrente> contas) {
