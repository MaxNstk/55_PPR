package visao;
import controller.ControllerMao;
...
//	private List<Mao> maos = new ArrayList<>();
	private MaoModel maoModel;
        private ControllerMao controller ;
    ...
    public void pcGanhou() {
        ...
        class MaoModel extends AbstractListModel<Mao> {
            ...
            public Mao getElementAt(int index) {
                    return controller.getMaos().get(index);
            }

            @Override
            public int getSize() {
                    return controller.getMaos().size();
            }
...
//		sorteio = new Random();
	...
	private void addEventos() {
		...
		jbJogar.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
                            controller.jogarPartida(jrbPar.isSelected());                               
			}
